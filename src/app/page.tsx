...
export default async function Home() {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section - Home */}
      <section id="home" className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-pink-50 relative overflow-hidden">
        ...
        <div className="h-screen flex items-center py-6 relative z-10">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              {/* Left Content */}
              <div className="space-y-6">
                <div>
                  <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold text-black mb-3 leading-none">
                    Hult Prize
                  </h1>
                ...
                <div className="flex justify-end">
                  {user ? (
                    <Link href="/dashboard" className="bg-pink-500 text-white w-12 h-12 rounded-full flex items-center justify-center hover:bg-pink-600 transition-colors shadow-lg">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                      </svg>
                    </Link>
                  ) : (
                    <Link href="/signup" className="bg-pink-500 text-white w-12 h-12 rounded-full flex items-center justify-center hover:bg-pink-600 transition-colors shadow-lg">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                      </svg>
                    </Link>
      ...
      {/* About Section */}
      <section id="about" className="min-h-screen h-screen bg-gradient-to-br from-pink-50 via-white to-pink-50 relative overflow-hidden">
        <AboutCarousel />
      </section>
      ...
      <section id="team" className="min-h-screen bg-white py-20 flex items-center">
        <div className="container mx-auto px-4 w-full">
          <h2 className="text-5xl md:text-6xl font-bold text-black mb-12 text-center">Our Team</h2>
          <div className="grid md:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((item) => (
              <div key={item} className="text-center space-y-4">
                <div className="w-48 h-48 mx-auto rounded-full bg-gradient-to-br from-pink-200 to-pink-100 flex items-center justify-center">
                  <p className="text-gray-500">Team Member {item}</p>
                </div>
                <h3 className="text-xl font-bold text-black">Team Member {item}</h3>
      ...
      {/* Contact Section */}
      <section id="contact" className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-pink-50 py-20 flex items-center">
        <div className="container mx-auto px-4 w-full">
          <h2 className="text-5xl md:text-6xl font-bold text-black mb-12 text-center">Get in Touch</h2>
          <div className="max-w-2xl mx-auto space-y-8">
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-black">Contact Information</h3>
              <p className="text-lg text-gray-600">
                <strong>Email:</strong> hultprize@khwopa.edu.np
              </p>
              <p className="text-lg text-gray-600">
                <strong>Phone:</strong> +977-1-234-5678
              </p>
              <p className="text-lg text-gray-600">
                <strong>Address:</strong> Khwopa College of Engineering, Libali, Bhaktapur
              </p>
            </div>
